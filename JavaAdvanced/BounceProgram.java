// Design Bouncing of a Ball using AWT and Swing
import javax.swing.*;
import java.awt.*;
import java.util.ArrayList;
public class BounceProgram {
    ...
    void run() {
        ...
        for (int i = 0; i < 50; i++) {
            Ball ball = new Ball(
                ...
                (int) Math.floor(Math.random() * windowWidth), (int) Math.floor(Math.random() * windowHeight), /* Random size from 10 to 30 */
                (int) Math.floor(Math.random() * 20) + 10, /* Random RGB colors*/
                new Color(
                ...
                (int) Math.floor((Math.random() * 10) - 5), (int) Math.floor((Math.random() * 10) - 5)
            );
            balls.add(ball);
        }
        /* Initialize program */
